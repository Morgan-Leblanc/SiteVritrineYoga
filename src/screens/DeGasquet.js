    ...
    <div className="multipleDesignContainer">
      ...
      <p>
        ...
        <p>
          ...
          appliquée au yoga a la particularité de s’appuyer sur <br></br> la précision
          biomécanique des postures.{" "}
        </p>
        <p>
          Elle intègre un étirement juste et respectueux de la colonne
          vertébrale libérant le diaphragme et permettant <br></br> une respiration
        ...
        <p>
          ...
          libérant  <br></br>le diaphragme et sans poussée délétère vers le bas.{" "}
        </p>
